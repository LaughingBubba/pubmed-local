...
# proc elemText*(n: XmlNode): string {.inline.} =
#     ## Gets the associated text for an element node `n`.
#     ##
#     ## Does a non-recursive find of all the top level 
#     ## text nodes for an element and returns a concatenated
